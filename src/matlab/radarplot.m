...
%     'Color', cmat);
%
%      where cmat is a user-defined color-triplicate colormap
% 
% % Title properties
...
for ii = 1:row_count
    ...
    repeat_colors = fix(row_count/size(cmat, 1))+1;
    cmat = repmat(cmat, repeat_colors, 1);
    
%     color = rand(1,3);
    % Plot data points
    fill(x_circular, y_circular,cmat(ii,:),...
        'FaceColor', cmat(ii,:),...
        'EdgeColor', cmat(ii,:),...
        'FaceAlpha', 0.1);   
end
